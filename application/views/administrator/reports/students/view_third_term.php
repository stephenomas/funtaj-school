        ...
        <div class="">
            ...
            <?php if ($period === 'endofterm') : ?>
                ...
                <div class="text-center"><img src="<?= base_url($schoolLogo) ?>" class="rounded-circle" height="50px"
                    ...
                    <p class=""><h4>
                        <?php
                        if($term == 'Term 2' && (int)$stuYear->curr_year == 9){
                            echo 'Year 9 Mock Result';
                        }elseif($term == 'Term 2' && (int)$stuYear->curr_year == 12){
                ...
                <!--                Get Class Average-->
                <?php
                $class = $examget->first_row(); $class_group = $class->class_details; echo $class_group;
