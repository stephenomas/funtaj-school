                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                        <li class="nav-item">
                                            <a class="nav-link fw-bold p-3 active" href="#">All Mid Term Reports</a>
                                        </li>
                                       
                                    </ul>
                                    <h4 class="card-title">All Mid Term Reports</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?></td>
                                                <td><a href="<?= site_url('midterm/class/single?session='.$student->session.'&year='.$student->class_details.'&term='.$this->input->get('term').'&student='.$person->id.'') ?>">View Report</a></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
