    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <a href="../staff" onclick="old()" class="card bg-warning text-white-50">
                        <div class="card-body">
                            <h5 class="text-white"><i class="mdi mdi-account--off-outline me-3"></i>Active Staffs</h5>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                <li class="nav-item">
                                    <a class="nav-link fw-bold p-3 active" href="#">All Inactive Staffs</a>
                                </li>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                <?php $count = 0; $teachescheckedcount = 0; foreach ($oldStaff as $staff) : $count++ ?>
                                    <tr>
                                    <td><?=$count?></td>
                                        <td><?=$staff->fname?></td>
                                        <td><?=$staff->mname?></td>
