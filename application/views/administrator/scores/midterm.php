        ...
        <div class="col-md-6">
            <div class="d-flex border">
                ...
                foreach ($subjects as $asubs){ $count++;
                    echo '<tr><td data-label="#" >'.$count.'</td><td data-label="Subject" class="">'.$asubs->subjects.'</td><td><a href="'.base_url('scores/midtermscores/'.$asubs->id).'" class=""><i class="fa fa-edit"></i></a></td></tr>';
                }
                echo '</tbody></table>';
                ?>
            </div>
    ...
    <div class="col-md-6">
        <div class="d-flex border">
            ...
            foreach ($tsub->result() as $tsubs){ $count++;
                echo '<tr><td data-label="#" >'.$count.'</td><td data-label="Subject" class="">'.$tsubs->subject_title.'</td><td><a href="'.base_url('scores/midtermscores/'.$tsubs->id).'" class=""><i class="fa fa-edit"></i></a></td></tr>';
            }
            echo '</tbody></table>';
            ?>
        </div>
