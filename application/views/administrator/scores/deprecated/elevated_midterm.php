...
<div class="row mb-4">
        ...
        <div class="col-md-6">
            <div class="d-flex">
                ...
                echo '<span class="text-center"><h4>Choose class to enter scores for '.'<span class="text-danger">'.strtoupper($subs->subjects).'</span>'.'</h4></span>';
                ?>
            </div>
                        ...
                        <div class="modal fade" id="enterScores<?=$cle->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <?php endif;?>
                                    <div class="modal-body mx-3"><?php $formIndex = 0 ?>
                                        <p class="card text-danger" style="font-size: small">Key: (A: Excellent | 1: Highest) | (E: Poor - 5: Lowest) </p>
                                        <form id="midterm<?=$formIndex?>" method="post" action="<?=base_url('scores/enterMTScores')?>">
                                        <input type="hidden" name="class_details" value="<?=$classDetails?>">
                                        <input type="hidden" name="subject" value="<?=$scoreSubject?>">
                                            ...
                                            foreach ($stuget->result() as $stu) : $stuCount++; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-label="Clear" class="text-center">
                                                        <button type="reset" onclick="clearMidtermScore('<?=(int)$stu->id?>', '<?=$scoreSubject?>')" class=" btn btn-outline-dark" value="Reset">Reset</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            </tbody>
