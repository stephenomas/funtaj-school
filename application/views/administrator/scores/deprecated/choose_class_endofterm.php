                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body mx-3">
                                        ...
                                        <input type="hidden" name="subject_title" value="<?=$tutor_sub?>">
                                        ...
                                        <table>
                                            ...
                                            foreach ($stuget->result() as $stu) : $stuCount++; ?>
                                                ...
                                                $this->db->where('subject_title', $tutor_sub);
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-label="CA%" class="text-center">
                                                        <input type="text" name="ca[]" value="<?php foreach ($endOfTermGet->result() as $eotg){
                                                            echo (!empty($eotg->ca) ? $eotg->ca : ' ');}?>" class="form-control" maxlength="4" style="width: 50px">
                                                    </td>
                                                    <td data-label="Exam%" class="text-center">
                                                        <input type="text" name="exam[]" value="<?php foreach ($endOfTermGet->result() as $eotg){
                                                            echo (!empty($eotg->exam) ? $eotg->exam : ' ');}?>" class="form-control" maxlength="4" style="width: 50px">
                                                    </td>
