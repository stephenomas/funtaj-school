        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                    <?php $count = 0; foreach ($deactivatedStudents as $student) : $count++ ?>
                        <tr>
                            ...
                            <td data-label="Edit"><a href="" class="" data-toggle="modal" data-target="#studentEdit<?=$student->id?>">Edit</a></td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <?=form_open('students/editDaStudent')?>
                                            <input type="hidden" name="url" value="<?=current_url()?>">
                                            <input type="hidden" name="id" value="<?=$student->id?>">
                                            <input type="hidden" name="admno" value="<?=$student->admno?>">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="">Reason</i></span>
                                                </div>
                                                <input type="text" name="reason" value="<?=$student->left_school_reason?>" class="form-control">
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="">First Name</i></span>
                            ...
                            <div class="modal fade" id="passwordEdit<?=$student->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body mx-3">
                                            <?=form_open('students/editDaPassword')?>
                                            <input type="hidden" name="url" value="<?=current_url()?>">
                                            <input type="hidden" name="id" value="<?=$student->id?>">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                            ...
                            <td data-label="Activate"><?=anchor("students/activateStudent/" . $student->id, "<i class='fa fa-exclamation-circle'></i>", array('onclick' => "return confirm('Do you really want to activate this student?')", 'class' => '')) ?></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
