        ...
        <div id="content" class="main-content">
            <div class="container">
                ...
                foreach($year->result() as $years){
                 if($prev != $years->class_details){
                ?>
                    <a href="<?= site_url('student-portal/results/endofterm-report?term='.$years->term.'&year='.$years->class_details.'&session='.$years->session) ?>" class="col-xl-4 col-md-6 col-12">
                        <div class="widget-content-area br-4 mb-4">
                            <div class="d-flex justify-content-between t-likes">                                
                                <div class="">
                                    <p class="mb-0"><?= $years->session ?></p>
                                    <h5 class="mb-0"><?= $years->class_details ?></h5>
                                </div>
                                <div class="">
