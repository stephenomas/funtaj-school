                            ...
                            <div class="col-md-12 mb-5 mt-5">
                                <ul class="nav nav-pills mb-5 justify-content-between" id="pills-tab" role="tablist">
                                    <li class="col-xl-6 col-lg-6 col-md-6 col-12 nav-item text-center mb-5">
                                        <a class="nav-link" href="<?=site_url("student-portal/school-fees/pay")?>">
                                        ...
                                        <table id="column-filter" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Year <?= $fee->curr_year ?></td>
                                                    <td><?= $fee->amount_paid ?></td>
                                                    <td>
                                                    <?php 
                                                    $this->db->where('fee_year', $fee->curr_year);
                                                    $tot = $this->db->get('school_fees')->row();
                                                    echo $total = $tot->first_term + $tot->second_term + $tot->third_term;
                                                    ?>
                                                    </td>
                                                    <td>
                                                        <?php if($fee->status == "Full Payment"){
                                                            echo '<span class="shadow-none badge badge-success">Completed</span>';
                                                        }elseif($fee->status == "Part Payment"){
                                                            echo '<span class="shadow-none badge badge-info">Part Payment</span>';
                                                        }elseif($fee->status == 'Pending Approval'){
                                                            echo '<span class="shadow-none badge badge-warning">Pending Approval</span>';
                                                        }
                                                         ?>
