...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="funtajadmin/assets/images/favicon.ico">

        <!-- Bootstrap Css -->
        <link href="funtajadmin/assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="funtajadmin/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="funtajadmin/assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
