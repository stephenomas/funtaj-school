...
<head>
    ...
    <meta charset="utf-8" />
    <title>Classes | Funtaj - Dashboard</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Year 7A</td>
                                                <td><a href="" data-bs-toggle="modal" data-bs-target="#editInfo">Edit</a> | <a href="" data-bs-toggle="modal" data-bs-target="#editTutor">Tutor</a> | <a href="">Delete</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="col-sm-6 col-md-4 col-xl-3">
                                        ...
                                        <?php include 'inc/edit-class.php'; ?>

                                         <!-- To add new class -->
                                        <?php include 'inc/add-class.php'; ?>

                                        <!-- To manage Tutor -->
                                        <?php include 'inc/class-tutor.php'; ?>
                                    </div>
