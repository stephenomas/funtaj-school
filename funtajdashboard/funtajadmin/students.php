                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a href="#" class="card bg-danger text-white-50">
                                <div class="card-body">
                                    <h5 class="text-white"><i class="mdi mdi-account-multiple-remove-outline me-3"></i> Deleted Students</h5>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-6 col-md-4 col-xl-3">
                                        ...
                                        <?php include 'inc/edit-student.php'; ?>

                                         <!-- To add new student -->
                                        <?php include 'inc/add-student.php'; ?>
                                    </div>
