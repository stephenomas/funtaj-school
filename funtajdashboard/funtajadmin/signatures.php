...
<head>
    ...
    <meta charset="utf-8" />
    <title>Signatures | Funtaj - Dashboard</title>
...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <?php 
        $this->load->view('inc/top-bar')
        //include 'inc/topbar.php'; ?>

        <!-- ========== Left Sidebar Start ========== -->
        <?php 
          $this->load->view('inc/siderbar')
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Mrs Funke Ibrahim</td>
                                                <td>Principal</td>
                                                <td>Gudu</td>
                                                <td>term 1</td>
                                                <td>2017/2018</td>
                                                <td><img src="" alt="Signature picture"></td>
                                    ...
                                    <div class="col-sm-6 col-md-4 col-xl-3">
                                         ...
                                         <!-- To add new student -->
                                        <?php 
                                        $this->load->view('inc/upload-signature')
    ...
    <script src="<?=base_url()?>assets/js/bootadmin.min.js"></script>
    <script src="<?=base_url()?>assets/js/tlcustom.js"></script>
    <script src="<?=base_url()?>assets/js/tlbroadsheet.js"></script>
    <script src="<?=base_url()?>assets/js/tlstore.js"></script>
