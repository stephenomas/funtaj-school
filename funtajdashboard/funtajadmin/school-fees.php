...
<head>
    ...
    <meta charset="utf-8" />
    <title>School Fees | Funtaj - Dashboard</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body tab-content">
                                    ...
                                    <div class="tab-pane active" id="studentlist" role="tabpanel">
                                        <span class="d-flex">
                                            <form class="app-search row">
                                                ...
                                                <div class="position-relative col-md-3 mb-2">
                                                        <input class="form-control" list="datalistOptions3" id="exampleDataList" placeholder="Branch">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Bank Draft</td>
                                                    <td>
                                                        <div class="badge badge-soft-warning font-size-12">Awaiting verification</div>
                                                    </td>
                                                    <td><a href="">View</a> | <a href="#" data-bs-toggle="modal" data-bs-target="#editInfo">Edit</a></td>
                                                </tr>
                                            </tbody>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="validationCustom01" placeholder="the least percentage allowed to be deposited" value="70" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="validationCustom02" placeholder="Last name" value="First Term" required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="validationCustom04" placeholder="Second Term" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="validationCustom05" placeholder="Third Term" required>
                                                        <div class="invalid-feedback">
                                                            Please provide a valid number.
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-4 col-xl-3">
                                        <!-- To display School Fees -->
                                        <?php include 'inc/student-receipt.php'; ?>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end col -->
