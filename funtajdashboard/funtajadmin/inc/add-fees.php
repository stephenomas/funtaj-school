    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <form class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addInfoTitle">New School Fees</h5>
            ...
            <div class="modal-body">
                ...
                <div id="div1" style="display: none;">
                    <div class="row mb-3">
                        <label for="firstname" class="col-sm-3 col-form-label">Session (900,000)</label>
                        <div class="col-sm-9">
                ...
                <div id="div2" style="display: none;">
                    <div class="row mb-3">
                        <label for="firstname" class="col-sm-3 col-form-label">First Term (300,000)</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="" id="firstname">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="Other" class="col-sm-3 col-form-label">Second Term (300,000)</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="" id="Other">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="firstname" class="col-sm-3 col-form-label">Third Term (300,000)</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" placeholder="" id="firstname">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary waves-effect waves-light">Pay</button>
            </div>
        </form><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->